...
while true do
	...
	if reactor ~= nil then
		...
		print("                        damage percent: " .. tostring(reactor.getDamagePercentage()))
		print("                        heat: " .. tostring(reactor.getTemperature()))
		print("                        fuel amount: " .. tostring(reactor.getFuel()["amount"]) .. "/" .. tostring(i.getFuelCapacity()))
		print("                        fuel percentage: " .. tostring(reactor.getFuelFilledPercentage()))
		print("                        coolant amount: " .. tostring(reactor.getCoolant()["amount"]) .. "/" .. tostring(i.getCoolantCapacity()))
		print("                        coolant percentage: " .. tostring(reactor.getCoolantFilledPercentage()))
		print("                        waste amount: " .. tostring(reactor.getWaste()["amount"]) .. "/" .. tostring(i.getWasteCapacity()))
		print("                        waste percentage: " .. tostring(reactor.getWasteFilledPercentage()))
		print("===================================================")
		if key ~= nil then
			if key == "enter" then
